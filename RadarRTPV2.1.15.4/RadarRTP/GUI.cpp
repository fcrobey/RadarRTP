...
/*
		...
		int TBXPos = DispSize.right - DispSize.left - iControlPanelWidth + 10;
		HWND hTrack = GetDlgItem(hWnd, IDC_SLIDER1);
		RECT sliderSize;
		GetWindowRect(hTrack, &sliderSize);
		SetWindowPos(hTrack, NULL, TBXPos, 500, 0, 0, SWP_NOZORDER | SWP_NOSIZE);

		hTrack = GetDlgItem(hWnd, IDC_SLIDER2);
		SetWindowPos(hTrack, NULL, TBXPos, 550, 0, 0, SWP_NOZORDER | SWP_NOSIZE);
*/
